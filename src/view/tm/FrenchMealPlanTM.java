...
public class FrenchMealPlanTM {
     private String mealNo;
     private String mealName;
     private double priceOfOnePotion;
     private Button btn;

    public FrenchMealPlanTM() {
    }

    public FrenchMealPlanTM(String mealNo, String mealName, double priceOfOnePotion, Button btn) {
        this.mealNo = mealNo;
